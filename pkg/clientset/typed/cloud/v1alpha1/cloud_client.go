...
// CloudV1alpha1Client is used to interact with features provided by the cloud group.
type CloudV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudV1alpha1Client) Targets(namespace string) TargetInterface {
	return newTargets(c, namespace)
}

func (c *CloudV1alpha1Client) Users(namespace string) UserInterface {
