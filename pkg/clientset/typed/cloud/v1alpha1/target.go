...
import (
	...
	v1alpha1 "github.com/apecloud/kubeblocks/apis/cloud/v1alpha1"
	scheme "github.com/apecloud/kubeblocks/pkg/clientset/scheme"
)
...
func newTargets(c *CloudV1alpha1Client, namespace string) *targets {
	return &targets{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *targets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetList, err error) {
...
func (c *targets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
